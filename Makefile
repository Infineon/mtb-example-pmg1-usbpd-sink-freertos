...
DEFINES=CY_PD_SINK_ONLY=1 CY_PD_REV3_ENABLE=1 VBUS_OVP_ENABLE=1 VBUS_UVP_ENABLE=0 SYS_DEEPSLEEP_ENABLE=1 BATTERY_CHARGING_ENABLE=1 \
        MINOR_SVDM_VER_SUPPORT=1 CY_APP_ROLE_PREFERENCE_ENABLE=0 CY_APP_POWER_ROLE_PREFERENCE_ENABLE=0 CY_APP_VBUS_C_FET_CTRL=0 \
        LEGACY_PD_PARALLEL_OPER=1 APPLE_SINK_DISABLE=0 QC_AFC_CHARGING_DISABLED=0 QC_AFC_SNK_EN=1 CY_APP_RTOS_ENABLED=1
